...
hiddenimports = [
    "azure_translator", "batch_queue", "cad_convert", "native_bridge", "python_multipart", "text_cleaning_utils", "web_api", "web_launcher",
...
pyz = PYZ(a.pure)
exe = EXE(
    pyz, a.scripts, a.binaries, a.datas, [], name="Honsen_CAD_Translator_v1.8.3",
