...
pyz = PYZ(a.pure)
exe = EXE(pyz, a.scripts, [], exclude_binaries=True, name="Honsen_CAD_Translator_v1.9.4", console=False, target_arch=None, codesign_identity=codesign_identity)
collection = COLLECT(exe, a.binaries, a.datas, name="Honsen_CAD_Translator_v1.9.4")
app = BUNDLE(collection, name="Honsen CAD Translator.app", bundle_identifier="com.honsen.cad-translator", codesign_identity=codesign_identity, info_plist={"CFBundleDisplayName": "Honsen CAD Translator", "CFBundleShortVersionString": "1.9.4", "CFBundleVersion": "1.9.4", "NSHighResolutionCapable": True})
