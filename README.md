...
npm run build
cd ..
pyinstaller --clean --noconfirm Honsen_CAD_Translator_v1.7.0.spec
```

生成文件为 `dist/Honsen_CAD_Translator_v1.7.0.exe`。如需开箱支持 DWG，请将完整 ODA 目录放在 `dist/ODAFileConverter/`。
