...
$exe = Join-Path $Root "dist\Honsen_CAD_Translator_v1.7.0.exe"
...
& $iscc (Join-Path $Root "installer\Honsen_CAD_Translator_v6.0.iss")

$setup = Join-Path $Root "installer_output\Honsen_CAD_Translator_v1.7.0_Setup.exe"
if (Test-Path $setup) {
