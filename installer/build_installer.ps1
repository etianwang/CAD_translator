...
pyinstaller Honsen_CAD_Translator_v1.9.5.spec

$exe = Join-Path $Root "dist\Honsen DrawTranslate v1.9.5.exe"
...
$setup = Join-Path $Root "installer\Output\Honsen_DrawTranslate_v1.9.5_Setup.exe"
if (Test-Path $setup) {
